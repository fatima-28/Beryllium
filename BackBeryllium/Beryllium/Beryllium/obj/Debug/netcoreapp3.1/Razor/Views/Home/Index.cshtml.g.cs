#pragma checksum "C:\Users\mac\Desktop\BERYLLIUM\BackBeryllium\Beryllium\Beryllium\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8f9a42f2137613462b54e868c8ab82139175a2be"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8f9a42f2137613462b54e868c8ab82139175a2be", @"/Views/Home/Index.cshtml")]
...
#nullable disable
    ...
    <section id=""work"">
        ...
        <div class=""work-items"">
            ...
            <div class=""image-cards"">
                <div class=""work-item-cart "">
                    <img src=""http");
            WriteLiteral(@"s://demos.freehtml5.co/beryllium/images/img_1.jpg"" alt=""place image"">
                    <p class=""title cart-text"">New York Arena</p>
                    <p class=""place cart-text"">New York</p>
                </div>
            </div>
            ...
            <div class=""image-cards"">
                <div class=""work-item-cart "">
                    <img src=""https://demos.freehtml5.co/beryllium/images/img_3.jpg"" alt=""place image"">
                    <p class=""title cart-text"">New ");
            WriteLiteral(@"York Arena</p>
                    <p class=""place cart-text"">New York</p>
                </div>
            </div>
            <!-- work single item end -->
 ...
 ");
            WriteLiteral(@"           <!-- work single item end -->
            <!-- work single item start -->
            <div class=""image-cards"">
                <div class=""work-item-cart "">
                    <img src=""https://demos.freehtml5.co/beryllium/images/img_3.jpg"" alt=""place image"">
        ...
        <div class=""news-testimonials-div"">
            ...
            WriteLiteral(@""">
                ...
                <div class=""manila"">
                    ...
                    <p class=""manila-text"">
                        Lorem ipsum ");
            WriteLiteral(@"dolor sit amet, consectetur adipiscing elit. Phasellus<br>
                        placerat enim et urna sagittis, rhoncus euismod...
                    </p>
                </div>
